...
var partial_arg = /* `Multipart */[
  -1031569716,
  partial_arg_001
];

function payload(param) {
  return Refetch__Request.payload(partial_arg, param);
}
        ...
        return /* () */0;
            ...
            if (param.tag) {
              ...
              return Curry._1(Refetch__Response.text, param[1]);
                ...
                ], Refetch.request(/* POST */891112544, undefined, undefined, undefined, "https://requestb.in/183okup1")))));
